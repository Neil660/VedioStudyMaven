...
public class ConverVideoUtils {
    ...
    private String videofolder = VedioStudyConstants.videofolder; 		// 别的格式视频的目录
    private String targetfolder = VedioStudyConstants.targetfolder; 	// flv视频、截图的目录
    private String ffmpegpath = VedioStudyConstants.ffmpegpath;		 // ffmpeg.exe的目录
    private String mencoderpath = VedioStudyConstants.mencoderpath; 	// mencoder的目录
    ...
    public boolean processImg(String sourceVideoPath) {
        ...
        commend.add("image2");
        commend.add("-y");
        commend.add(targetfolder + filerealname + ".png");		//生成截图xxx.jpg
