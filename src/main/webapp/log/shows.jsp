    ...
    <div class="col-sm-3 col-md-2 sidebar">
        ...
        <div class="drop-navigation drop-navigation">
            <ul class="nav nav-sidebar">
                ...
                <li class="active"><a class="user-icon"><span class="glyphicon glyphicon-home glyphicon-blackboard" aria-hidden="true"></span>视频学习课程</a></li>
                <%
                    if(id > 0){
                %>
			...
			<div class="main-grids">
				<div class="recommended">
					<div class="recommended-grids english-grid">
                        ...
                        <%
                            ...
                            vedioJavaList = showDAO.findCateShow("JAVA");
						...
						<div class="col-md-2 resent-grid recommended-grid sports-recommended-grid">
							...
							<div class="resent-grid-info recommended-grid-info">
								...
								<p class="author"><a href="#" class="author"><%=vedio.getPublisher() %></a></p>
								<p class="views"><%=vedio.getCount() %> views</p>
							</div>
						</div>
                        <%
                            }
				...
				<div class="recommended">
					<div class="recommended-grids">
                        ...
                        <%
                            ...
                            vedioCList = showDAO.findCateShow("C/C++");
				...
				<div class="recommended">
					<div class="recommended-grids">
                        ...
                        <%
                            List<Vedio> vedioPList = null;
                            vedioPList = showDAO.findCateShow("Python");
                            for(Vedio vedio:vedioPList){
                        %>
						<div class="col-md-2 resent-grid recommended-grid sports-recommended-grid">
							<div class="resent-grid-img recommended-grid-img">
								<a href="../SingleServlet?vedioID=<%=vedio.getId() %>"><img src="../<%=vedio.getUrl()%>.png" alt="" /></a>
