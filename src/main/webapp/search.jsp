  ...
  <body>
    ...
    <div class="drop-navigation drop-navigation">
        <ul class="nav nav-sidebar">
            ...
            <li class="active"><a href="index.jsp" class="home-icon"><span class="glyphicon glyphicon-home" aria-hidden="true"></span>首页</a></li>
            <li><a href="shows.jsp" class="user-icon"><span class="glyphicon glyphicon-home glyphicon-blackboard" aria-hidden="true"></span>视频学习课程</a></li><!-- script-for-menu -->
            <script>
            ...
            <div class="recommended-info">
                ...
                <div class="history-grids">
                    ...
                    <div class="col-md-11 history-right">
                        <h5><a href="SingleServlet?vedioID=<%=vedioList.get(i).getId() %>" class="title"><%=vedioList.get(i).getVedioTitle() %></a></h5>
                        <p>发布于：<%=vedioList.get(i).getRelease() %></p>
                    </div>
                    <div class="clearfix"> </div>
                </div>
                <%
